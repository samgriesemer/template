...
"let s:gb.dark0       = ['#232425', 235]     " 40-40-40
"let s:gb.dark0       = ['#21212E', 235]     " 40-40-40
...
"let s:gb.light1      = ['#D4C5A1', 229]     " 253-244-193
let s:gb.light1      = ['#D1C9B4', 229]     " 253-244-193
let s:gb.light2      = ['#d5c4a1', 250]     " 213-196-161
let s:gb.light3      = ['#bdae93', 248]     " 189-174-147
let s:gb.light4      = ['#a89984', 246]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

"let s:gb.bright_red     = ['#d63b36', 167]     " 251-73-52
"let s:gb.bright_green   = ['#7d8c1b', 142]     " 184-187-38
"let s:gb.bright_yellow  = ['#deba2a', 214]     " 250-189-47
"let s:gb.bright_blue    = ['#779ABF', 109]     " 131-165-152
"let s:gb.bright_purple  = ['#656096', 175]     " 211-134-155
"let s:gb.bright_aqua    = ['#74a687', 108]     " 142-192-124
"let s:gb.bright_orange  = ['#d97178', 208]     " 254-128-25


let s:gb.bright_red    = ['#e0543f', 124]     " 204-36-29
let s:gb.bright_green  = ['#bdb948', 106]     " 152-151-26
let s:gb.bright_yellow = ['#ffbb33', 172]     " 215-153-33
let s:gb.bright_blue   = ['#7baac9', 66]      " 69-133-136
let s:gb.bright_purple = ['#7a618f', 132]     " 177-98-134
let s:gb.bright_aqua   = ['#79a66f', 72]      " 104-157-106
let s:gb.bright_orange = ['#f08e48', 72]      " 104-157-106

let s:gb.neutral_red    = ['#d45946', 124]     " 204-36-29
let s:gb.neutral_green  = ['#b0ad4c', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#f2b63d', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#7da3bd', 66]      " 69-133-136
let s:gb.neutral_purple = ['#725f82', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#76996e', 72]      " 104-157-106
let s:gb.neutral_orange = ['#e38d4f', 72]      " 104-157-106
"
let s:gb.faded_red    = ['#c65b4b', 124]     " 204-36-29
let s:gb.faded_green  = ['#a29f4e', 106]     " 152-151-26
let s:gb.faded_yellow = ['#e5af45', 172]     " 215-153-33
let s:gb.faded_blue   = ['#7d9cb1', 66]      " 69-133-136
let s:gb.faded_purple = ['#6a5c76', 132]     " 177-98-134
let s:gb.faded_aqua   = ['#728d6c', 72]      " 104-157-106
let s:gb.faded_orange = ['#d78c55', 72]      " 104-157-106
"
"let s:gb.faded_red      = ['#c94540', 88]      " 157-0-6
"let s:gb.faded_green    = ['#738021', 100]     " 121-116-14
"let s:gb.faded_yellow   = ['#d1b236', 136]     " 181-118-20
"let s:gb.faded_blue     = ['#7B96B3', 24]      " 7-102-120
"let s:gb.faded_purple   = ['#65628a', 96]      " 143-63-113
"let s:gb.faded_aqua     = ['#769983', 66]      " 66-123-88
"let s:gb.faded_orange   = ['#cc787e', 130]     " 175-58-3
