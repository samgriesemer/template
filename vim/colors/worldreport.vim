...
let s:gb.neutral_red    = ['#ca3732', 124]     " 204-36-29
let s:gb.neutral_green  = ['#728018', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#d0ae28', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#6f90b3', 66]      " 69-133-136
let s:gb.neutral_purple = ['#5b5789', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#6b987c', 72]      " 104-157-106
let s:gb.neutral_orange = ['#cc6b72', 72]      " 104-157-106
"let s:gb.neutral_orange = ['#C46442', 166]     " 214-93-14
"
...
hi! link markdownUrl        GruvboxOrange
hi! link markdownInlineUrl  GruvboxGreen
