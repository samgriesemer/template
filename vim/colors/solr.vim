...
let s:gb.dark0       = ['#002b36', 235]     " 40-40-40
"let s:gb.dark0       = ['#25252E', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 236]     " 50-48-47
let s:gb.dark1       = ['#073642', 237]     " 60-56-54
let s:gb.dark2       = ['#586e75', 239]     " 80-73-69
let s:gb.dark3       = ['#586e75', 241]     " 102-92-84
let s:gb.dark4       = ['#586e75', 243]     " 124-111-100
let s:gb.dark4_256   = ['#7c6f64', 243]     " 124-111-100

let s:gb.gray_245    = ['#586e75', 245]     " 146-131-116
let s:gb.gray_244    = ['#586e75', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#839496', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#839496', 229]     " 253-244-193
let s:gb.light2      = ['#839496', 250]     " 213-196-161
let s:gb.light3      = ['#839496', 248]     " 189-174-147
let s:gb.light4      = ['#839496', 246]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

let s:gb.bright_red    = ['#e93431', 124]     " 204-36-29
let s:gb.bright_green  = ['#81b705', 106]     " 152-151-26
let s:gb.bright_yellow = ['#ca9700', 172]     " 215-153-33
let s:gb.bright_blue   = ['#2596e7', 66]      " 69-133-136
let s:gb.bright_purple = ['#646adc', 132]     " 177-98-134
let s:gb.bright_aqua   = ['#1dc4b6', 72]      " 104-157-106
let s:gb.bright_orange = ['#e55010', 72]      " 104-157-106
let s:gb.bright_magenta = ['#e4378a', 72]      " 104-157-106

"let s:gb.bright_red    = ['#dc322f', 124]     " 204-36-29
"let s:gb.bright_green  = ['#719e07', 106]     " 152-151-26
"let s:gb.bright_yellow = ['#b58900', 172]     " 215-153-33
"let s:gb.bright_blue   = ['#268bd2', 66]      " 69-133-136
"let s:gb.bright_purple = ['#6c71c4', 132]     " 177-98-134
"let s:gb.bright_aqua   = ['#2aa198', 72]      " 104-157-106
"let s:gb.bright_orange = ['#cb4b16', 72]      " 104-157-106
"let s:gb.bright_magenta = ['#d33682', 72]      " 104-157-106

let s:gb.neutral_red    = ['#dc322f', 124]     " 204-36-29
let s:gb.neutral_green  = ['#719e07', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#b58900', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#268bd2', 66]      " 69-133-136
let s:gb.neutral_purple = ['#6c71c4', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#2aa198', 72]      " 104-157-106
let s:gb.neutral_orange = ['#cb4b16', 72]      " 104-157-106
let s:gb.neutral_magenta = ['#d33682', 72]      " 104-157-106

let s:gb.faded_red    = ['#dc322f', 124]     " 204-36-29
let s:gb.faded_green  = ['#719e07', 106]     " 152-151-26
let s:gb.faded_yellow = ['#b58900', 172]     " 215-153-33
let s:gb.faded_blue   = ['#268bd2', 66]      " 69-133-136
let s:gb.faded_purple = ['#6c71c4', 132]     " 177-98-134
let s:gb.faded_aqua   = ['#2aa198', 72]      " 104-157-106
let s:gb.faded_orange = ['#cb4b16', 72]      " 104-157-106
let s:gb.faded_magenta = ['#d33682', 72]      " 104-157-106
...
hi! link markdownH2 GruvboxOrange
hi! link markdownH3 GruvboxOrange
hi! link markdownH4 GruvboxOrange
hi! link markdownH5 GruvboxOrange
hi! link markdownH6 GruvboxOrange
...
hi! link markdownLink       GruvboxGreen
hi! link markdownWikiLink   GruvboxPurple
hi! link markdownUrl        GruvboxYellow
